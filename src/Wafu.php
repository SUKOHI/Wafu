...
class Wafu {
    ...
    public function convertJapaneseDate($date) {
        ...
        $patterns = [
            '!((明治|大正|昭和|平成|令和)[\d]+年)([\d]+)月([\d]+)日 ([\d]+)時([\d]+)分([\d]+)!',
            '!((明治|大正|昭和|平成|令和)[\d]+年)([\d]+)月([\d]+)日 ([\d]+)時([\d]+)分!',
            '!((明治|大正|昭和|平成|令和)[\d]+年)([\d]+)月([\d]+)日 ([\d]+)時!',
            '!((明治|大正|昭和|平成|令和)[\d]+年)([\d]+)月([\d]+)日 ([\d]+):([\d]+):([\d]+)!',
            '!((明治|大正|昭和|平成|令和)[\d]+年)([\d]+)月([\d]+)日 ([\d]+):([\d]+)!',
            '!((明治|大正|昭和|平成|令和)[\d]+年)([\d]+)月([\d]+)日!',
            '!((明治|大正|昭和|平成|令和)[\d]+年)([\d]+)月!',
            '!(明治|大正|昭和|平成|令和[\d]+)年!',
            '!((M|T|S|H|R)[\d]+).([\d]+).([\d]+) ([\d]+)時([\d]+)分([\d]+)!',
            '!((M|T|S|H|R)[\d]+).([\d]+).([\d]+) ([\d]+)時([\d]+)分!',
            '!((M|T|S|H|R)[\d]+).([\d]+).([\d]+) ([\d]+)時!',
            '!((M|T|S|H|R)[\d]+).([\d]+).([\d]+) ([\d]+):([\d]+):([\d]+)!',
            '!((M|T|S|H|R)[\d]+).([\d]+).([\d]+) ([\d]+):([\d]+)!',
            '!((M|T|S|H|R)[\d]+).([\d]+).([\d]+)!',
            '!((M|T|S|H|R)[\d]+).([\d]+)!',
            '!((M|T|S|H|R)[\d]+)!',
    ...
    public function commonEraYear($japanese_era_year) {
        ...
        if(preg_match('!(明治|大正|昭和|平成|令和|M|T|S|H|R)([0-9]{1,2}|元)[年]?!', $japanese_era_year, $matches)) {

            $era_name = $matches[1];
            $era_year = ($matches[2] == '元') ? 1 : $matches[2];

            if($era_name == '令和' || $era_name == 'R') {
